...
ternary_to_x(a,b) = ternary_to_x(a,b,1-a-b)
ternary_to_y(a,b,c) = √3 / 2 * (c / (a + b + c))
ternary_to_y(a,b) = ternary_to_y(a,b,1-a-b)
...
"""
@recipe function f(::Type{Val{:ternaryplot}}, plt::AbstractPlot)
    # Get x and y values to plot
    x, y = plotattributes[:x], plotattributes[:y]
    # TODO: Filter out infinite values using isfinite()
